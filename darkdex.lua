-- We didn't make any of these scripts!! They are FREE for use, but if you include them in your exploit, PLEASE credit the creator of these scripts.
-- Credits to DarkDex (SYNAPSE Edition) Creators
